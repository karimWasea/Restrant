...
namespace DataAcessLayers.Migrations
{
    ...
    [Migration("20240819171836_PaymentRecord")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAcessLayers.Applicaionuser", b =>
                {
                    ...
                    b.Property<string>("FullCustumName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DataAcessLayers.FinancialUserCashHistory", b =>
                {
                    ...
                    b.Property<int>("HospitalOroprationtyp")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAcessLayers.NotPayedmoneyHistory", b =>
                {
                    ...
                    b.Property<int>("HospitalaoOrprationtyp")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAcessLayers.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAcessLayers.PaymentRecord", b =>
                {
                    b.HasOne("DataAcessLayers.NotPayedmoney", "UnpaidMoney")
                        .WithMany()
                        .HasForeignKey("UnpaidMoneyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UnpaidMoney");
                });
